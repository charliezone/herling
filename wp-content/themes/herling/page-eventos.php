    ...
    <div id="eventos">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 d-flex flex-column justify-content-center align-items-start">
                        <h1>MIS EVENTOS</h1>
                        <small class="mt-3">Te acompaño a cuestionar tu vida y construirla como se te pegue la gana.</small>
                    </div>
                    <div class="col-md-6">
        ...
        <section class="section padding-bottom over-hide background-dark-2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="event ajax-form bg-white p-5 mt-3">
                            ...
                            <p class="description text-dark">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente dolore inventore rem ad? Consectetur, adipisci doloremque. Ex, fuga nisi architecto excepturi, consectetur nesciunt incidunt porro magni facere minima optio! Earum.</p>
