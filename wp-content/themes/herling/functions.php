...
function herling_styles_scripts() {
    ...
    wp_enqueue_style( 'style-custom', get_template_directory_uri() . '/css/custom.css', array('style-theme') );
    wp_enqueue_style( 'herling-custom-style', get_stylesheet_uri(), array('style-custom'), '1.0.0' );
    ...
    wp_register_script( 'script-custom', get_template_directory_uri() . '/js/custom.js', array('script-plugins'), '', true );
